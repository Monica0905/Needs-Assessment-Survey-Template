...
#stat <- read_csv("../Data/Statistica_Methodology_Needs.csv")
...
This report is generated based on a **synthetic** dataset representing responses to a survey to assess the current needs and use of statisticians and software engineers across the university. This dataset contains `r n_participant` responses.
